...
def tester(dataset, dataloader, device, target_model, E, defG, eps, out_path, model_name, label_count=True, save_img=False):
...
def test_full(device, target_model, E, defG, eps, out_path, model_name, label_count=True, save_img=True):
    ...
    tester(mnist_dataset, train_dataloader, device, target_model, E, defG, eps, out_path, model_name, label_count, False)
    ...
    tester(mnist_dataset_test, test_dataloader, device, target_model, E, defG, eps, out_path, model_name, label_count, save_img)
...
if __name__ == '__main__':
    ...
    test_full(device, target_model, E, defG, args.eps, out_path, model_name, label_count=True)
